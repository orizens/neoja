export const links = [
  ...
  [
    ...
    "A series of guided meditations to help boost creativity",
  ],
  [
    "confidence",
    ...
    "A series of guided meditations to help boost self esteem and confidence",
  ],
  [
    "calm",
    ...
    "A series of guided meditations to help achieve a calm peaceful state of mind",
  ],
];
